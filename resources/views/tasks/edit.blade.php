...
@endif
             ...
             <h3 class="display-5 text-center">Edit task Page</h3>
...
<div class="form-group mb-3">
    <label for="courseName" class="mb-2">Choose Course Name:</label>
    ...
    <input type="text" id="taskTitle" name="taskTitle" value="{{ $task->task_title }}" required>
    
    <div class="form-group">
        <label for="taskDescription">Task description:</label>
        <textarea class="form-control mt-1 mb-3" id="taskDescription" name="taskDescription" >{{ $task->task_text }}</textarea>
    </div>
    ...
    @if($task->image_path)
        <img src="{{ asset('storage/' . $task->image_path) }}" class="img-fluid p-4" alt="Current Image">
